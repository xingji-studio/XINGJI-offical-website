        ...
        <div class="grid grid-cols-1 gap-4">
          <div v-for="tool in devTools"
            ...
            <div class="flex flex-wrap gap-3">
              ...
              <a :href="tool.origin_url" download
