...
useHead({
  title: 'Download XJ380 | XINGJI Studio',
  meta: [
    {
      name: 'description',
...
const devTools = ref([
  {
    ...
    url: 'https://gitee.com/GuoqiFish/xingji-interactive-software-download-item-storage/releases/download/20260519-1/XJ380_XACT_2026v4_xj380.zip',
  ...
  },
  {
    ...
    url: 'https://gitee.com/GuoqiFish/xingji-interactive-software-download-item-storage/releases/download/20260519-1/XJ380_XACT_2026v4_windows.zip',
  ...
  },
  {
    ...
    url: 'https://gitee.com/GuoqiFish/xingji-interactive-software-download-item-storage/releases/download/20260519-1/XJ380_XACT_2026v4_linux.zip',
  ...
  },
  {
    ...
    url: 'https://gitee.com/GuoqiFish/xingji-interactive-software-download-item-storage/releases/download/20260519-1/XJ380_API_Spec_CPP_1_3.pdf',
  ...
  },
  {
    ...
    url: 'https://gitee.com/GuoqiFish/xingji-interactive-software-download-item-storage/releases/download/20260519-1/XJ380_CPP_API_Depend_1_3.zip',
...
<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 pt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div class="bg-gray-800/50 backdrop-blur-md rounded-2xl p-8 mb-8">
        ...
        <div v-for="version in versions" :key="version.version" class="space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a v-for="download in version.downloads" 
               :key="download.name"
               :href="download.url"
      ...
      <!-- System Requirements -->
      <div class="bg-gray-800/50 backdrop-blur-md rounded-2xl p-8 mb-8">
        <h2 class="text-2xl font-bold text-white mb-6">最低配置要求</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div v-for="req in requirements" 
               :key="req.name"
        ...
        <div class="grid grid-cols-1 gap-4">
          <div v-for="tool in devTools"
            ...
            <div class="flex flex-wrap gap-3">
              ...
              <a :href="tool.githubUrl"
                 class="inline-flex items-center px-4 py-2 rounded-lg bg-orange-800/20 text-orange-400 hover:bg-orange-500/30 transition-colors duration-200 text-sm">
                Github 下载
                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
