...
const devTools = ref([
  { name: 'XJ380 应用程序编译套件（XACT for Windows）', url: 'https://xjfs.cn-nb1.rains3.com/XJ380_XACT_2026v1_windows.zip' },
  { name: 'XJ380 应用程序编译套件（XACT for Linux）', url: 'https://xjfs.cn-nb1.rains3.com/XJ380_XACT_2026v1_linux.zip' },
  { name: 'XJ380 API 标准文档（C/C++）', url: 'https://xjfs.cn-nb1.rains3.com/XJ380_API_Spec_CPP_1_1.pdf' },
  { name: 'XJ380 API 静态链接库及头文件（C/C++）', url: 'https://xjfs.cn-nb1.rains3.com/XJ380_CPP_API_Depend_1_1.zip' }
])
